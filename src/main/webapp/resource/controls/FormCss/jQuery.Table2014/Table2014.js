    ...
    $.fn.table2014 = function (options) {
        ...
        return this.each(function () {
            ...
            var rendTable = function () {
                ...
                // 表头
                if (opt.tableHeader) {
                    var header = $('<div class="table-row table-header"></div>')
                        .appendTo(rowsContainer);
                    $.each(opt.columns, function (i) {
                        var cell = $('<div class="table-cell"><a href="#"></a></div>').appendTo(header);

                        cell.find('a').text(this.header);

                        cell.data('colName', this.colName);
                        ...
                        cell.css('text-align', this.align || 'left');
                    });
                }
            ...
            var renderTableBody = function (bodyData, rowsContainer) {
                ...
                if (opt.onTableRendered && $.isFunction(opt.onTableRendered)) {
                    opt.onTableRendered();
                }
            }
