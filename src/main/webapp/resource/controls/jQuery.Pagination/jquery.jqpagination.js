...
(function ($) {
	...
	$.jqPagination = function (el, options) {
		...
		base.init = function () {
			...
			base.$input.off('focus.jqPagination mouseup.jqPagination')
                .on('focus.jqPagination mouseup.jqPagination', function (event) {
            ...
            base.$input.off('blur.jqPagination keydown.jqPagination')
            .on('blur.jqPagination keydown.jqPagination', function (event) {
			...
			base.$el.off('click.jqPagination').on('click.jqPagination', 'a', function (event) {
		...
		base.setLinks = function (page) {
			...
			// for ie8 bug: not repaint after addClass
