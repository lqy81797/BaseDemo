    ...
    var methods = {
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var leftPane = $('div[layout=left]', $this);
                var centerPane = $('div[layout=center]', $this);
                var dragbarCollapse = $('div.dragbar-collapse', $this);

                // get additional parameters
                if (leftPane.attr('layout-width')) {
                    settings.leftPaneWidth = leftPane.attr('layout-width');
                }
                if (leftPane.attr('layout-minWidth')) {
                    settings.leftPaneMinWidth = leftPane.attr('layout-minWidth');
                }
                if (leftPane.attr('layout-maxWidth')) {
                    settings.leftPaneMaxWidth = leftPane.attr('layout-maxWidth');
                }
