        ...
        return this.each(function () {
            ...
            var methods = {
                ...
                select: function (nodeId) {
                    var node = $('.TreeNode[data-id=' + nodeId + ']', $(this));
                    $('.TreeNodeSelected', $elem).removeClass('TreeNodeSelected');
            ...
            var bindEvent = function () {
                ...
                .off('mouseout', '.TreeNode').on('mouseout', '.TreeNode', function () {
                    ...
                    var selectedNode = $('.TreeNodeSelected', $elem); // $('.TreeNodeSelected');//
                    var selectedNodeId = selectedNode.data("id");
                    if (selectedNodeId == $(this).data("id")) {
                        $(this).removeClass('TreeNodeSelected');
                    } else {
                        selectedNode.removeClass('TreeNodeSelected');
